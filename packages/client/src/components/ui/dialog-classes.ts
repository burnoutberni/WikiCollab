export const DIALOG_CONTENT_CLASSES = {
  ...
  mobile: 'inset-0 w-full h-full overflow-y-auto overscroll-contain rounded-none border-none',
  mobileAnimation:
  ...
  desktop:
    'md:inset-auto md:left-[50%] md:top-[50%] md:h-auto md:w-full md:max-w-lg md:translate-x-[-50%] md:translate-y-[-50%] md:rounded-lg md:border md:overflow-visible md:overscroll-auto',
