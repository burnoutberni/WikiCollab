...
export function ConnectionStatePopover({
  ...
  const statusIcon = connected ? (
    <span className="relative">
      ...
      {collaboratorCount > 1 && (
        <span className="absolute -top-1.5 -right-1.5 bg-green-500 text-white text-[8px] font-bold rounded-full min-w-[14px] h-3.5 flex items-center justify-center leading-none px-0.5">
          {collaboratorCount}
        </span>
      )}
    </span>
